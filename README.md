...
You have to design & build the backend for the application and the ability for the users to register, list and buy the products.
...
https://github.com/azaylamba/udaan 
